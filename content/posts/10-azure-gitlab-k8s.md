...
GitLab Runner를 Kubernetes에 붙이고 나면, CI Job이 실행될 때마다 임시 Pod가 생성되고 종료되는 과정을 눈으로 확인할 수 있습니다. 이 글에서는 Azure 환경을 예로 들어, GitLab을 자체 호스팅하고 AKS에 Runner를 배포하는 과정을 정리했습니다.
