...
const projects = [
  {
    ...
    description: '최신 밈 트렌드를 제공하는 MCP 서버와 이를 활용한 챗봇 웹사이트',
  ...
  },
  {
    ...
    description: '스트리밍 처리와 배치 처리를 아우르는 IoT 데이터 파이프라인 구축 프로젝트',
  ...
  },
  {
    ...
    description: 'AWS 서비스를 활용한 미디어(VOD/실시간) 스트리밍 프로젝트',
  ...
  },
  {
    ...
    description: 'KakaoCloud 기반 하이브리드 클라우드 환경 쇼핑몰 플랫폼',
  ...
  },
  {
    ...
    description: 'TTS AI 및 ko-GPT를 활용한 블로그 서비스',
    techStack: ['SpringBoot', 'FastAPI', 'Kafka', 'MongoDB', 'MySQL', 'Redis'],
              ...
              <div className="flex flex-wrap gap-2">
                {project.techStack.map((tech) => (
                  <span
                    ...
                    className="text-xs px-2 py-1 bg-accent-bg text-gray-600 font-medium rounded border border-accent/20"
                  >
                    {tech}
                  </span>
                ))}
