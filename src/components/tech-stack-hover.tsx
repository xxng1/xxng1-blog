    ...
    <div>
      ...
      <div className="flex flex-wrap gap-3">
        {items.map((item) => (
          ...
          >
            <span className="inline-flex items-center gap-2 px-3 py-1 bg-accent-bg text-gray-600 font-medium rounded-full text-sm border border-accent/20 cursor-pointer hover:bg-accent-bg transition-colors">
